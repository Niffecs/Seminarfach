...
public class RunGenKeys extends RunnableBase {
    ...
    public void run(Vector<String> args) {
        ...
        try {
            ...
            KeyPairGenerator keygen = KeyPairGenerator.getInstance(CRYPTO_ALGORITHMUS);
            ...
            System.out.println("Private      Schluesseldatei : " + file1.getCanonicalPath());
            System.out.println("Oeffentliche Schluesseldatei : " + file2.getCanonicalPath());

        } catch (NoSuchAlgorithmException eNsM) {
            System.err.println("Der Algorithmus '" + CRYPTO_ALGORITHMUS + "' ist nicht implementiert!");
            System.exit(2);
    ...
    private void writeToFile(PrivateKey pk, File privateKeyFile) {
        ...
        try {
            ...
            System.out.println("Exception(writeToFile(PrivateKey)): " + ex.getMessage());
            System.exit(2);
        } finally {
            try {
                if (out != null) {
                ...
                System.err.println("EX2: Exception(writeToFile(PrivateKey)): " + ex2.getMessage());
                System.exit(2);
    ...
    private void writeToFile(PublicKey pk, File publicKeyFile) {
        ...
        try {
            ...
            System.out.println("Exception(writeToFile(PublicKey)): " + ex.getMessage());
            System.exit(2);
        } finally {
            try {
                if (out != null) {
                ...
                System.err.println("EX2: Exception(writeToFile(PublicKey)): " + ex2.getMessage());
                System.exit(2);
